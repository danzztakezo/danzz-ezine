...
<?=$this->load->view('left_panel');?>  
  ...
  <div id="col3">
    <div id="col3_content" class="clearfix">
      ...
      <h2> <?=$title_page;?></h2>
        <div id="contentLeft">
          <form method="post" action="<?=base_url();?>auction_items_backend/edit/<?=$id?>" id="editForm">
            <span >
            ...
            <span >
              <label for="incontent"> Sampul Album * :</label>
                <div id="display_picture"> 
                  <img src="<?php echo base_url().'images/items/Thumbs/'.$rows_a[0]->thumb;?>" height='52px' weight='50px'/>
                </div> 
            ...
            <span >
              <label for="intitle"> Gudang *:</label> 
              <select name="author" id="author">
                <?php 
                if(count($warehouse)>0){
                  foreach($warehouse as $au){
                    echo "<option value='".$au->id."'>$au->name</option>";   
                  }
                }
                 ?>
              </select>
              ...
              <table width="100%" border='0' class="table" >
                ...
                <?php
                  foreach($rows_g as $g){
                    ...
                    // echo "<td></td>";
                    echo "<tr id='tr_".$g->id."'>
                          <td><img src='".base_url()."images/picture_items/Thumbs/".$g->thumb."' height='52px' weight='50px'/>

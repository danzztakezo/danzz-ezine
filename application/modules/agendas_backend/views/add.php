      ...
      <h2> <?php echo $title_page; ?></h2>
        <div id="contentLeft">
          <form method="post" action="<?=$form_action;?>" id="addForm">
           <span >
            <label for="intitle"> Nama *:</label> <input type="text" name="name" id="name" class="required"/> 
            </span>
           <span >
            <label for="intitle"> Title *:</label> <input type="text" name="intitle" id="intitle" class="required"/> 
            </span>
           <span >
            <label for="incontent"> Deskripsi * :</label> <textarea name="indescription" id="indescription" cols="30" rows="5" class="required"> </textarea> 
            </span>
            <span >
              <label for="agendastime"> Tanggal / Waktu *:</label> <input type="text" name="agendastime" id="agendastime" class="required"/> 
            </span>
            <span >
              <label for="venue"> Tempat *:</label> <input type="text" name="venue" id="venue" class="required"/> 
            </span>
